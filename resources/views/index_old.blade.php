  ...
  <body>
        ...
        <div class="row d-flex">
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text mt-3">
              	<div class="posted mb-3 d-flex">
              		<div class="img author" style="background-image: url('{{ asset('images/person_3.jpg') }}');"></div>
              		<div class="desc pl-3">
              			<span>Posted by John doe</span>
              			<span>24 February 2020</span>
              		</div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text mt-3">
              	<div class="posted mb-3 d-flex">
              		<div class="img author" style="background-image: url('{{ asset('images/person_1.jpg') }}');"></div>
              		<div class="desc pl-3">
              			<span>Posted by John doe</span>
              			<span>24 February 2020</span>
              		</div>
    ...
    <section class="ftco-section ftco-no-pb">
          ...
          <div class="col-md-3 ftco-animate">
            <div class="work img d-flex align-items-end" style="background-image: url('{{ asset('images/work-1.jpg') }}');">
          ...
          <div class="col-md-3 ftco-animate">
            <div class="work img d-flex align-items-end" style="background-image: url('{{ asset('images/work-2.jpg') }}');">
          ...
          <div class="col-md-3 ftco-animate">
            <div class="work img d-flex align-items-end" style="background-image: url('{{ asset('images/work-3.jpg') }}');">
          ...
          <div class="col-md-3 ftco-animate">
            <div class="work img d-flex align-items-end" style="background-image: url('{{ asset('images/work-4.jpg') }}');">
